...
# Legacy fallback 12-utterance script. Tuples:
# (speaker_id, text, start_offset_ms_within_cycle)
MOCK_SCRIPT: list[tuple[str, str, int]] = [
    ("speaker-1", "Суд начинается. Прошу всех встать.", 500),
    ("speaker-1", "Заседание продолжается. Слушаем первую сторону.", 4200),
    ("speaker-2", "Позвольте изложить обстоятельства дела.", 7800),
    (
        "speaker-2",
        "По нашему мнению, решение было принято с нарушением процедуры.",
        13200,
    ),
    ("speaker-1", "Спасибо. Слово предоставляется второй стороне.", 19200),
    ("speaker-3", "Мы не согласны с представленной позицией.", 22200),
    (
        "speaker-3",
        "Все процедуры были соблюдены в полном объёме, согласно действующему законодательству.",
        26200,
    ),
    ("speaker-4", "Разрешите дополнить позицию первой стороны.", 32200),
    ("speaker-1", "Пожалуйста.", 35200),
    (
        "speaker-4",
        "Согласно представленным материалам, заявленные требования подлежат рассмотрению.",
        37200,
    ),
    ("speaker-1", "Объявляется перерыв. Прошу всех оставаться на местах.", 45000),
    ("speaker-2", "Спасибо.", 49200),
]
